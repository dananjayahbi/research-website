        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-6">
              <span className="text-2xl font-bold text-blue-400 mr-2">R</span>
              <span className="text-xl font-semibold">Research Project</span>
            </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 space-y-3">
              <p className="flex items-start">
                ...
                123 Research Way, Science City, 12345
              </p>
              <p className="flex items-start">
                <svg className="w-5 h-5 mr-3 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Research Project. All rights reserved.
            </p>
